...
<table width="90%" border="1" align="center">
      <tr>
        <td bordercolor="#330033" bgcolor="#CCCCFF"><h1 align="center"><strong><span class="style1">VIEW BIM ATTENDANCE</span></strong></h1>
        </td>
      </tr>
      ...
      <tr>
		...
		if(isset($_POST["btnsubmit"]))
		{
			...
			extract($_POST);
			$query = "select * from `student` where faculty = 'BIM' and registration = ".$eno." limit 1";
			...
			while($rec = mysqli_fetch_array($result))
			{
				...
				<tr>
				  ...
				  $query1 = "select * from `bim_attendance` where `id` = ".$rec["id"]." order by date";
