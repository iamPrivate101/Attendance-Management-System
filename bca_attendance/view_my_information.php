      ...
      <tr>
        ...
        <form action="" method="post" style="margin-top: 20px;">
          <table width="90%" border="2" align="center" bordercolor="#9966FF" bgcolor="#C7B6B1">
            ...
            <tr>
              <td width="50%" bgcolor="#9999CC"><div align="center"><strong><span class="style2">Enter the Registration no</span></strong></div></td>
              <td width="50%" bgcolor="#9999CC"><span class="style6">
		...
		if(isset($_POST["btnsubmit"]))
		{
			...
			$result = mysqli_query($conn,$query)or die("Check Registration Number");
