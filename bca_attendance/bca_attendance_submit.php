...
<?php
    if(isset($_POST["btnsubmit"]))
    {
        ...
        while($rec = mysqli_fetch_array($result))
        {
            ...
            if(isset($_POST[$mno]))
            {
                $query1 = "INSERT INTO  `bca_attendance`(`id` ,  `date` ,  `attendance`) VALUES('$mno','$date','1')";
            }
            else
            {
                $query1 = "INSERT INTO  `bca_attendance`(`id` ,  `date` ,  `attendance`) VALUES('$mno','$date','0')";
            }
            mysqli_query($conn,$query1)or die("insert error".$mno);
            print "<script>";
            print "alert('Attendance get successfully....');";
            print "self.location='bca_attendance.php';";
            print "</script>";
        }
