...
if(isset($_SESSION['uname'])){
  ...
  echo ' 
 <title>BSc.CSIT ATTENDANCE</title>
...
<div class="container-fluid">
    <div class="row">
      ...
      <tr>
        <td bordercolor="#330033" bgcolor="#CCCCFF"><h1 align="center"><strong><span class="style1">BSc.CSIT ATTENDANCE</span></strong></h1></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>
        <form action="csit_attendance_submit.php" method="post">
        <table width="180px" align="left" style="">
          ...
          <table width="50%" border="2" align="left" bordercolor="#9966FF" bgcolor="#C7B6B1" style="margin-left:20px;">
            ...
            include "../dbconnect/conn.php";
                extract($_POST);
                $query = "select *from student where faculty = 'BSc.CSIT' order by id";
                $s = 0;
