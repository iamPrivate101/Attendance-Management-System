...
<table width="90%" border="1" align="center">
      <tr>
        <td bordercolor="#330033" bgcolor="#CCCCFF"><h1 align="center"><strong><span class="style1">VIEW BSc.CSIT ATTENDANCE</span></strong></h1>
        </td>
      </tr>
      ...
      <tr>
		...
		if(isset($_POST["btnsubmit"]))
		{
			...
			extract($_POST);
			$query = "select * from `student` where faculty = 'BSc.CSIT' and registration = ".$eno." limit 1";

			$result = mysqli_query($conn,$query)or die("Registration Number Not Matched");
			while($rec = mysqli_fetch_array($result))
			{
				...
				<tr>
				  ...
				  $query1 = "select * from `csit_attendance` where `id` = ".$rec["id"]." order by date";
		...
		else
		{
			include "../dbconnect/conn.php";
			extract($_POST);
			$query = "select * from `student` where faculty = 'BSc.CSIT' ";
